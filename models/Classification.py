...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        if configs.llm_model == 'LLAMA':
            ...
            self.llama_config = LlamaConfig.from_pretrained(r'E:\dayoung\Llama-3-8B')
            ...
            self.gpt2_config = GPT2Config.from_pretrained('E:\dayoung\gpt2')
            ...
            self.bert_config = BertConfig.from_pretrained(r'E:\dayoung\bert-base-uncased')
            ...
            self.deepseek_config.num_hidden_layers = 2
            ...
            try:
                ...
                print("Local model files not found. Attempting to download...")
                self.llm_model = AutoModelForCausalLM.from_pretrained(
                    r'E:\dayoung\Qwen2.5-VL-7B-Instruct',
                    trust_remote_code=True,
                    local_files_only=False
                )
