...
def fft_feature(data, sampling_rate, device):
    """
    获取频域特征
    """
...
def my_read_csv(input_csv, window_size, overlap, i, nrows=10000, usecols=0):
    # 读取数据
...
def read_data(csv_root, image_root, window_size=1024, overlap=512):
    """
    csv_root (28, 600)
    ...
    for i, csv_file in enumerate(os.listdir(csv_root)):
        ...
        # print(csv_name)
        # 获取csv acc数据
        windowed_df, lab = my_read_csv(csv_name, window_size, overlap, i)
